...
> iOS 风格的 Windows 桌面课程表 —— Excel 导入、开课提醒、拖动改课、作业与 DDL。
...
| ✅ **作业关联** | 课程详情里可直接添加作业，作业会同步出现在待办清单并绑定该课程 |
...
| 🎨 **极简有设计感** | 毛玻璃材质、柔和光斑背景、iOS 分段控件与开关、Framer Motion 弹簧动画、`prefers-reduced-motion` 降级 |
